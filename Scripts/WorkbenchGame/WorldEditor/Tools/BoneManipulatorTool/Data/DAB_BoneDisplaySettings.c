...
class DAB_BoneDisplaySettings
{
	...
	//-----------------------------------------------------------------------
	void DAB_BoneDisplaySettings(bool hideIKTargetBones, bool hidePropBones, bool hideVolumeBones, bool hideCameraBone, bool hideFaceBones, bool hideBoneConnections, string filterBoneName = "")
	{
